+++
author = "Vu Tran"
title = "Scalable blog design system"
...
# Blog system designed for serving massive readers (10k tps) 


*Note: This document links directly to relevant areas found in the [system design topics](https://github.com/donnemartin/system-design-primer#index-of-system-design-topics) to avoid duplication.  Refer to the linked content for general talking points, tradeoffs, and alternatives.*

## 1. Some assumption about the design.

This project is must more in general. Therefore, to clarify what goal I would like to achieve here, some necessary aspects about the scope of the system are defined as below.

### The context
Assuming this web application are created to serve people who want to read other's blog and write blog on their own. A blog may be attached with some tags that describe what aspects the blog are talked about. In that way, it would be easy for someone who want to read their desired blogs by filtering the tag. Beside, they also can insert images, videos in their blogs.

### Use cases

* A paritcular **User** can makes a read or a write request (create and read the blog).
    * **Service** does processing, stores user data (image, video), then returns the results
* **Service** needs the ability to serve a million of users.
...
## 3: Explaination used components:

> Dive into details for each core component.

There are many solutions to solve a particular scalable problem. In term of this blog project, stem from the fact that there is no way that I can check out the performance of the system, I would like to use as many as possible solutions until I feel the system is good enough to cope with the given massive reader.

### About vertical scaling
Vertical scaling can get increasingly expensive as the more highthe things 
